namespace DotSpatial4
{
    partial class AboutBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 10F));
            tableLayoutPanel.Size = new Size(1038, 346);
            ...
            labelProductName.Location = new Point(349, 0);
            labelProductName.Margin = new Padding(7, 0, 4, 0);
            labelProductName.MaximumSize = new Size(0, 22);
            labelProductName.Name = "labelProductName";
            labelProductName.Size = new Size(685, 22);
            ...
            labelVersion.Location = new Point(349, 34);
            labelVersion.Margin = new Padding(7, 0, 4, 0);
            labelVersion.MaximumSize = new Size(0, 22);
            labelVersion.Name = "labelVersion";
            labelVersion.Size = new Size(685, 22);
            ...
            labelCopyright.Location = new Point(349, 68);
            labelCopyright.Margin = new Padding(7, 0, 4, 0);
            labelCopyright.MaximumSize = new Size(0, 22);
            labelCopyright.Name = "labelCopyright";
            labelCopyright.Size = new Size(685, 22);
            ...
            labelCompanyName.Location = new Point(349, 102);
            labelCompanyName.Margin = new Padding(7, 0, 4, 0);
            labelCompanyName.MaximumSize = new Size(0, 22);
            labelCompanyName.Name = "labelCompanyName";
            labelCompanyName.Size = new Size(685, 22);
            ...
            textBoxDescription.Location = new Point(349, 140);
            textBoxDescription.Margin = new Padding(7, 4, 4, 4);
            textBoxDescription.Multiline = true;
            textBoxDescription.Name = "textBoxDescription";
            textBoxDescription.ReadOnly = true;
            textBoxDescription.ScrollBars = ScrollBars.Both;
            textBoxDescription.Size = new Size(685, 165);
